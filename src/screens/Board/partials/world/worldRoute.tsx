...
import { getStoreState, getWorldNews, storeActions } from "../../../../store";
export const WorldRoute = () => {
  ...
  const worldNewsData = useSelector(
    (rootState) => getStoreState(rootState).worldNewsData,
  );
  ...
  const onRefresh = useCallback(() => {
    setRefreshing(true);
    setData([{}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}]);
    dispatch(storeActions.setWorldNewsData([]));
