...
import { getHealthNews, getStoreState, storeActions } from "../../../../store";
export const HealthRoute = () => {
  ...
  const healthNewsData = useSelector(
    (rootState) => getStoreState(rootState).healthNewsData,
  );
  ...
  const onRefresh = useCallback(() => {
    setRefreshing(true);
    setData([{}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}]);
    dispatch(storeActions.setHealthNewsData([]));
