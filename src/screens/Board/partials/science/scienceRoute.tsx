...
import { getScienceNews, getStoreState, storeActions } from "../../../../store";
export const ScienceRoute = () => {
  ...
  const scienceNewsData = useSelector(
    (rootState) => getStoreState(rootState).scienceNewsData,
  );
  ...
  const onRefresh = useCallback(() => {
    setRefreshing(true);
    setData([{}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}]);
    dispatch(storeActions.setScienceNewsData([]));
